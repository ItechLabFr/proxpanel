...
Les notes historiques sont disponibles depuis **1.7.0-beta.1**. **v1.7.0-beta.14** est la première GitHub Release reproductible. La dernière prerelease publiée est **v1.7.2-beta.4.3**, avec ZIP complet, ZIP OTA, `release.json` et sommes SHA-256.
...
**1.7.2-beta.4.3 est la version active de cette série.** Elle conserve le Dashboard Docker/topologie, distingue correctement les WARNINGS Proxmox des échecs et enrichit les notifications warning/critical avec le contexte technique et des logs filtrés.
...
Dernière version de développement publiée : **1.7.2-beta.4.3**

Dernière GitHub Release publiée : **1.7.2-beta.4.3**

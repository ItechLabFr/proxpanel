...
Les notes historiques sont disponibles depuis **1.7.0-beta.1**. **v1.7.0-beta.14** est la première GitHub Release reproductible. La dernière prerelease publiée est **v1.7.2-beta.4.2**, avec ZIP complet, ZIP OTA, `release.json` et sommes SHA-256.
...
**1.7.2-beta.4.2 est la version active de cette série.** Elle conserve le Dashboard Docker/topologie de beta.4.1 et enrichit les e-mails warning/critical avec les informations techniques et logs disponibles.
...
Dernière version de développement publiée : **1.7.2-beta.4.2**

Dernière GitHub Release publiée : **1.7.2-beta.4.2**

const CACHE='proxpanel-v1.7.0-beta.14';
const CORE=['/','/index.html','/styles.css?v=1.7.0-beta.14','/app.js?v=1.7.0-beta.14','/manifest.webmanifest','/proxpanel-logo-192.png','/proxpanel-logo-256.png','/proxpanel-logo-512.png','/apple-touch-icon.png'];

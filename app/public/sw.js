const CACHE='proxpanel-v1.7.0-beta.15';
const CORE=['/','/index.html','/styles.css?v=1.7.0-beta.15','/app.js?v=1.7.0-beta.15','/manifest.webmanifest','/proxpanel-logo-192.png','/proxpanel-logo-256.png','/proxpanel-logo-512.png','/apple-touch-icon.png'];
...
self.addEventListener('fetch',e=>{
  ...
  const isAppAsset=u.pathname==='/styles.css'||u.pathname==='/app.js'||u.pathname==='/sw.js';
  if(isAppAsset){

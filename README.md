...
- **Wazuh Security Essentials** in beta.6: agents, important alerts, CVE/package remediation, Proxmox/Docker correlation and detailed Panel/e-mail/Discord security notifications;
- Automations 2.0;
- RBAC and Audit 2.0;
- Health Center 2.0.

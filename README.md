...
Historical notes are available from **1.7.0-beta.1** onward. **v1.7.0-beta.14** is the first reproducible GitHub Release. The latest published prerelease is **v1.7.2-beta.4.3**, with full ZIP, OTA ZIP, `release.json` and SHA-256 checksums.
...
**1.7.2-beta.4.3 is the active release in this series.** It keeps the Docker Dashboard/topology and correctly separates Proxmox task warnings from failures while enriching warning/critical notifications with technical context and redacted logs.
...
Latest published GitHub Release: **1.7.2-beta.4.3**
